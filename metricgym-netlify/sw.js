...
self.addEventListener("fetch", (e) => {
  ...
  if (url.origin !== self.location.origin) {
    // Ausnahme: three.js/Supabase-Bibliothek vom CDN cachen (cache-first),
    // damit 3D-Körper & Rauch-Sphäre auch offline funktionieren. Sonst unangetastet.
    if (/^https:\/\/(cdn\.jsdelivr\.net|unpkg\.com)\//.test(req.url)) {
